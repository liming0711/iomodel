...
const MenuBar: React.FC<MenuProps> = (props) => {
  ...
  useEffect(() => {
    if (data.length > 0) {
      console.log('--- setOpenKeys ---', [data[0].title, data[0].children![0].title]);
      console.log('--- setSelectedKeys ---', [data[0]!.children![0]!.children![0].key]);
      setOpenKeys([data[0].title, data[0].children![0].title, data[0]!.children![0]!.children![0].key]);
