        ...
        aa[key]['read'][filename].forEach((item) => {
          ...
          if (!existItem) {
            columns.push({
              ...
              title: key,
              children: [
                { key: `${prefix}_offset`, title: 'Offset', dataIndex: `${prefix}_offset` },
                { key: `${prefix}_length`, title: 'Length', dataIndex: `${prefix}_length` },
                { key: `${prefix}_count`, title: 'Count', dataIndex: `${prefix}_count` },
              ]
            });
          }
          dataItem[`${prefix}_offset`] = item[0][0];
          dataItem[`${prefix}_length`] = item[0][1];
          dataItem[`${prefix}_count`] = item[1];
        });
