  ...
  return (
    <div className="io-container">
      ...
      <div className="io-container-item">
        <Panel
          title="读写分布 Top10（图表）"
          subtitle={rwSeries.length !== 0 ? <span className="read-write-desc">缩写注释：RND - 随机， R - 读， W - 写</span> : null}
        >
      ...
      <div className="io-container-item">
        <Panel title="符合统计-ParaBuffer模式文件 (数据)" subtitle={<span className="parabuffer-desc">
