...
const bb = [
  { key: 'haha1', host1: 'computer1', offset1: 23, length1: 11, size1: '32MB', host2: 'computer1', offset2: 23, length2: 11, size2: '32MB', host3: 'computer1', offset3: 23, length3: 11, size3: '32MB', host4: 'computer1', offset4: 23, length4: 11, size4: '32MB', host5: 'computer1', offset5: 23, length5: 11, size5: '32MB', time: '2021-09-23_15:44:30' },
  { key: 'haha2', host1: 'computer2', offset1: 23, length1: 11, size1: '32MB', host2: 'computer2', offset2: 23, length2: 11, size2: '32MB', host3: 'computer2', offset3: 23, length3: 11, size3: '32MB', host4: 'computer2', offset4: 23, length4: 11, size4: '32MB', host5: 'computer2', offset5: 23, length5: 11, size5: '32MB', time: '2021-09-23_15:44:30' },
  { key: 'haha3', host1: 'computer3', offset1: 23, length1: 11, size1: '32MB', host2: 'computer3', offset2: 23, length2: 11, size2: '32MB', host3: 'computer3', offset3: 23, length3: 11, size3: '32MB', host4: 'computer3', offset4: 23, length4: 11, size4: '32MB', host5: 'computer3', offset5: 23, length5: 11, size5: '32MB', time: '2021-09-23_15:44:30' },
  { key: 'haha4', host1: 'computer4', offset1: 23, length1: 11, size1: '32MB', host2: 'computer4', offset2: 23, length2: 11, size2: '32MB', host3: 'computer4', offset3: 23, length3: 11, size3: '32MB', host4: 'computer4', offset4: 23, length4: 11, size4: '32MB', host5: 'computer4', offset5: 23, length5: 11, size5: '32MB', time: '2021-09-23_15:44:30' },
  { key: 'haha5', host1: 'computer5', offset1: 23, length1: 11, size1: '32MB', host2: 'computer5', offset2: 23, length2: 11, size2: '32MB', host3: 'computer5', offset3: 23, length3: 11, size3: '32MB', host4: 'computer5', offset4: 23, length4: 11, size4: '32MB', host5: 'computer5', offset5: 23, length5: 11, size5: '32MB', time: '2021-09-23_15:44:30' },
  { key: 'haha6', host1: 'computer6', offset1: 23, length1: 11, size1: '32MB', host2: 'computer6', offset2: 23, length2: 11, size2: '32MB', host3: 'computer6', offset3: 23, length3: 11, size3: '32MB', host4: 'computer6', offset4: 23, length4: 11, size4: '32MB', host5: 'computer6', offset5: 23, length5: 11, size5: '32MB', time: '2021-09-23_15:44:30' }
];
...
const IOContent: React.FC<IOContentProps> = (props) => {
  ...
  useEffect(() => {
    ...
    console.log('--- proportionDataSource ---', total_count);
    setProportionDataSource([deepmerge(true, { key: 'key111' }, total_count)]);
  }, [rw]);
  ...
  return (
    <div className="io-container">
      ...
      <div className="io-container-item">
        <Panel title="符合统计-ParaBuffer模式文件 (数据)" subtitle={<div className="parabuffer-desc">
        符合条件的文件 (20) global_snowfree_albedo.bosu.t1534.3072.1536.rg.grb,read  ,  global_snowfree_albedo.bosu.t1534.3072.1536.rg.grb,seek  ,  global_soilmgldas.t1534.3072.1536.grb,seek  ,  global_soilmgldas.t1534.3072.1536.grb,read  ,  gfs_data.latlon.nc,read  ,  gfs_data.latlon.nc,seek  ,  aerosol.dat,read  ,  RTGSST.1982.2012.monthly.clim.grb,read  ,  RTGSST.1982.2012.monthly.clim.grb,seek  ,  global_vegfrac.0.144.decpercent.grb,read  ,  global_vegfrac.0.144.decpercent.grb,seek  ,  CFSR.SEAICE.1982.2012.monthly.clim.grb,read  ,  global_snoclim.1.875.grb,read  ,  mld_DR003_c1m_reg2.0.grb,read  ,  CFSR.SEAICE.1982.2012.monthly.clim.grb,seek  ,  global_snoclim.1.875.grb,seek  ,  mld_DR003_c1m_reg2.0.grb,seek  ,  hioro_data.tile3.nc,read  ,  hioro_data.tile1.nc,read  ,  hioro_data.tile3.nc,seek
        </div>}>
          <Table
            dataSource={bb}
            columns={aa}
